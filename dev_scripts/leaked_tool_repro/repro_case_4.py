#!/usr/bin/env python3
"""
Reproduction script for leaked tool call case 4.

Source: leaked_tool_20260131_114941_897350.json
Timestamp: 2026-01-31T11:49:41.897416
Model: claudeopus45

This case shows a PURE tool call leak - the entire response content is just
the leaked tool call with no surrounding text. This is different from other
cases where tool calls are embedded within explanatory text.
...
LOG_FILE = Path(__file__).parent / "leaked_tool_20260131_114941_897350.json"
...
def main():
    """Main entry point."""
    print("=" * 60)
    print("LEAKED TOOL CALL REPRODUCTION - CASE 4")
    print("Pure tool call leak (no surrounding text)")
