#!/usr/bin/env python3
"""
Reproduction script for leaked tool call case 2.

Source: reference/bugs_report/leaked_tool_logs/leaked_tool_20260128_171653_513513.json
...
LOG_FILE = Path(__file__).parent / "leaked_tool_20260128_171653_513513.json"
...
def main():
    """Main entry point."""
    print("=" * 60)
    print("LEAKED TOOL CALL REPRODUCTION - CASE 2")
